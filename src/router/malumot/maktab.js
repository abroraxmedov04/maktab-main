...
import SmallImgOne from '../../assets/photo_2024-07-04_16-46-54.jpg'
import SmallImgSecond from '../../assets/photo_2024-07-04_16-47-01.jpg'
import SmallImgThree from '../../assets/photo_2024-07-04_16-47-06.jpg' 
...
import SmallImgFour from '../../assets/photo_2024-07-04_16-47-10.jpg'
function maktab() {
  return (
            ...
            <div className='small_boxx'>
               ...
               <div className='small_img'>
                ...
                <div className='small_text'>
                    <h2>АГАНИЯЗОВ ТОЛИБЖОН МУЗРАПОВИЧ</h2>
                    <h3>БОШ ҲИСОБЧИ</h3>
        ...
        <div className='container_box'>
            <div className='small_boxx'>
               ...
               <div className='small_img'>
                ...
                <div className='small_text'>
                    <h2>ЎРОЗОВ ДЎСМУРОД РЎЗИҚУЛОВИЧ</h2>
                    <h3>хўжалик ишлдари бўйича директор ўринбосари</h3>
                    <h5>Telefon: +998 55 901-54-34 </h5>
...
Payshanba - 1000 - 1200</h6>
        ...
        <div className='container_box'>
            <div className='small_boxx'>
               <div className='small_box'>
               <div className='small_img'>
                    <img className='img_small ds' src={SmallImgOne} alt="" />
               </div>
                <div className='small_text'>
                    <h2>Тилавова Ҳанифа Ҳасановна Директор</h2>
                    <h3>ЎҚУВ ИШЛАРИ БЎЙИЧА Директор</h3>
                    <h5>Telefon: +998 55 901-54-34 </h5>
        ...
        <div className='container_box'>
            <div className='small_boxx'>
               ...
               <div className='small_img'>
                ...
                <div className='small_text'>
                    <h2>ТЕМИРОВ ШАРОФИДДИН ҚУВАТОВИЧ</h2>
                    <h3>ЎҚУВ ИШЛАРИ БЎЙИЧА ДИРЕКТОР ЎРИНБОСАРИ</h3>
                    <h5>Telefon: +998 55 901-54-34 </h5>
